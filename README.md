...
[نسخه فارسی](https://github.com/amaz00088/v2ray-worker/blob/main/README-fa.md)
...
## Deploy 
 ...
 4. Edit this `README.md` file, then find and replace this button url bellow with yours `https://github.com/amaz00088/v2ray-worker` then save it.
 4. then press `Deploy With Workers` and follow the instruction

[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/amaz00088/v2ray-worker)
